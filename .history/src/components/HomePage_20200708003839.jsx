      ...
      <div className={classes.mainTextWrapper}>
        <div className={classes.column}>
          {lineBreaker(`
            ...
            Во-вторых, это студия производства эдьютейнмент-контента. Наконец, это курируемый и регулярно обновляемый блог с ссылками на любимое из того, что уже есть в сети. У нас есть рассылка, будем на связи.
          `)}
        </div>
        <div className={classes.divider} />
        <div className={classes.column}>
          {lineBreaker(`
              GLAZOK (༗)is a platform for borderline video content. We are interested in a space where theory and art intersect with education and entertainment, and the layering of various approaches and practices creates a bizarre cultural pattern on the other side of the division into tradition and experiment, mainstream and underground.
