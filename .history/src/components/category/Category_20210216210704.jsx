...
export const Category = ({ category, readMode, onSetReadMode, onSetPlayMode }) => {
  ...
  const coverImage = post & post.id % 2 === 0 
  ? 'https://d2kq0urxkarztv.cloudfront.net/56798cfc5d4e95117dc119a0/1926507/upload-43f44c24-8d71-43e1-9905-3eb8a3b0469d.png'
  : 'https://d2kq0urxkarztv.cloudfront.net/56798cfc5d4e95117dc119a0/1896648/upload-eec7e0b6-4384-483a-8a24-acf81f6ebf7f.png?e=webp&nll=true';
