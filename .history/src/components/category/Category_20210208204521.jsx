...
export const Category = ({ category }) => {
  ...
  const shouldRenderChild = useDelayUnmount(isMounted, 00);
  ...
  return (
    <ThemeContext.Consumer>
      {({ setTheme }) => (
        <>
          {category && post && shouldRenderChild && winWidth > global.maxWidth && (
            <>
                ...
                >
                  <div className={isMounted ? classes.visibleTwoColumns : classes.hiddenTwoColumns}>
                ...
                >
                  <div className={isMounted ? classes.visibleCoverImage : classes.hiddenCoverImage}>
