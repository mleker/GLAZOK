...
const createCategoryStyles = createUseStyles(() => ({
  ...
  frame: ({ i, background }) => ({
    ...
    overflow: 'hidden',
    paddingBottom: '56%',
    background: {i`url(https://d2kq0urxkarztv.cloudfront.net/56798cfc5d4e95117dc119a0/1926507/upload-43f44c24-8d71-43e1-9905-3eb8a3b0469d.png) center no-repeat`,
    backgroundSize: 'cover',
