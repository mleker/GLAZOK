...
export const Category = ({ category }) => {
  ...
  const embed_url = post && getHostName(post.embed_url);
  post && console.log('hostname', getHostName(post.embed_url));
  console.log('dom ===', (hostname === ('youtube.com' || 'youtu.be' || 'player.vimeo.com')));
        ...
        <div className={classes.coverImage}>
          <div className={classes.frameWrapper}>
            <div className={classes.frame}>
              {string.includes(substring) === 'youtube.com/embed' || hostname === 'youtu.be' || hostname === 'player.vimeo.com'
                ? (
                  <>
                    <div
                      className={classes.playLink}
                      onClick={() => setEmbedShowed(true)}
                    >
                      {'PLAY'}
                    </div>
                    {embedShowed && (
                      <iframe
                        ...
                        src={post.embed_url}
                        frameborder="0"
                        allow={hostname === 'player.vimeo.com'
