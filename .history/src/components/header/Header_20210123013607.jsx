...
const scrollHorizontally = (e, htmlEl) => {
  e = window.event || e;
  var delta = Math.max(-1, Math.min(e.wheelDelta || e.detail));
  htmlEl.scrollLeft -= delta * 40;
...
export const Header = () => {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('wheel', () => scrollHorizontally('wheel', menuWrapperHtmlEl.current), false);
    return () => {
