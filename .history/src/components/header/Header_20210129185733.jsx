...
export const Header = ({ categories, initialCurrentItem, onMenuClick}) => {
  ...
  React.useEffect(() => {
    if (initialCurrentItem >= 0) {
      console.log('scrollLeft', menuHtmlEls.current[initialCurrentItem].offsetLeft+ menuHtmlEls.current[initialCurrentItem].offsetWidth / 2);
      console.log('menuWrapperHtmlEl.current', menuHtmlEls.current[initialCurrentItem].offsetLeft+ menuHtmlEls.current[initialCurrentItem].offsetWidth / 2);
      ...
      menuWrapperHtmlEl.current.scrollLeft = menuHtmlEls.current[initialCurrentItem].offsetLeft + menuHtmlEls.current[initialCurrentItem].offsetWidth / 2;
    }
  }, [initialCurrentItem])
