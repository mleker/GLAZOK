...
export const Header = () => {
  ...
  const [currentItem, setCurrentItem] = React.useState(location);
  ...
  React.useEffect(() => {
    ...
    if (menuHtmlEls.current[0]) {
      console.log('menuHtmlEls.current[currentItem].offsetLeft', menuHtmlEls.current.find((item, i) => item.custom_url === currentItem].offsetLeft);
