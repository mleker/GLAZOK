...
export const Header = () => {
  ...
  React.useEffect(() => {
    window.addEventListener('mousewheel', () => scrollHorizontally('mousewheel', menuWrapperHtmlEl.current), false);
    menuWrapperHtmlEl.current.addEventListener('DOMMouseScroll', () => scrollHorizontally('DOMMouseScroll', menuWrapperHtmlEl.current), false);
    return () => {
