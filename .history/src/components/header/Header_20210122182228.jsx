...
export const Header = () => {
  ...
  const menuLeftIndent = menuHtmlEls.current && winWidth / 2 - menuHtmlEls.current[0].offsetWidth / 2;
  const menuRightIndent = menuHtmlEls.current[menuHtmlEls.current.length - 1] && winWidth / 2 - menuHtmlEls.current[menuHtmlEls.current.length - 1].offsetWidth / 2;
  console.log('menuItem1.current: ', menuHtmlEls.current[0]);
