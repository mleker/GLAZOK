...
export const Header = ({ categories, initialCurrentItem, onMenuClick }) => {
  ...
  React.useEffect(() => {
    if (initialCurrentItem >= 0) {
      menuWrapperHtmlEl.current.scroll  Left = menuHtmlEls.current[initialCurrentItem].offsetLeft - winWidth / 2 + menuHtmlEls.current[initialCurrentItem].offsetWidth / 2;
    }
  }, [initialCurrentItem])
