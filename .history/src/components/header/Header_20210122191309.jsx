...
export const Header = () => {
  ...
  const [firstAndLastMenuHtmlEls, setFirstAndLastMenuHtmlEls] = React.useState({});
  const menuHtmlEls = React.useRef({});
  const menuLeftIndent = firstAndLastMenuHtmlEls[0] && winWidth / 2 - firstAndLastMenuHtmlEls[0].offsetWidth / 2;
  ...
  React.useEffect(() => {
    ...
    if (menuHtmlEls.current) {
      setFirstAndLastMenuHtmlEls(menuHtmlEls.current[0], menuHtmlEls.current[menuHtmlEls.current.length - 1]);
      console.log('firstAndLastMenuHtmlEls: ', menuHtmlEls.current[0]);
    }
