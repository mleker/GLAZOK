...
export const Header = ({ categories, currentItem }) => {
  ...
  const menuHtmlEls = React.useCallback(node => {
    if (node !== null) {
      setMenuLeftIndent(winWidth / 2 - node[0].offsetLeft - node[0].offsetWidth / 2);
      setMenuRightIndent(winWidth / 2 - node[node.length - 1].offsetWidth / 2 - 30);
      ...
      console.log('scrollLeft', node[currentItem].offsetLeft - winWidth / 2 + node[currentItem].offsetWidth / 2)
    }
  });
  ...
  React.useEffect(() => {
    if (menuHtmlEls.current[currentItem]) {
      ...
      menuWrapperHtmlEl.current.scrollLeft = menuHtmlEls.current[currentItem].offsetLeft - winWidth / 2 + menuHtmlEls.current[currentItem].offsetWidth / 2;
      console.log('scrollLeft', menuHtmlEls.current[currentItem].offsetLeft - winWidth / 2 + menuHtmlEls.current[currentItem].offsetWidth / 2)
    }
  }, [categories])
