...
const scrollHorizontally = (e, htmlEl) => {
  ...
  htmlEl.scrollLeft -= (delta * 40); // Multiplied by 40
  e.preventDefault();
}
...
export const Header = () => {
  ...
  React.useEffect(() => {
    menuWrapperHtmlEl.current.addEventListener('mousewheel', () => scrollHorizontally('mousewheel', menuWrapperHtmlEl), false);
    menuWrapperHtmlEl.current.addEventListener('DOMMouseScroll', () => scrollHorizontally('DOMMouseScroll', menuWrapperHtmlEl), false);
    return () => {
      menuWrapperHtmlEl.current.removeEventListener('mousewheel', scrollHorizontally);
      menuWrapperHtmlEl.current.removeEventListener('DOMMouseScroll', scrollHorizontally);
    }
  })
