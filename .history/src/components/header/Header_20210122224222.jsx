...
const createHeaderStyles = createUseStyles((menuLeftIndent, menuRightIndent) => ({
...
export const Header = () => {
  ...
  console.log('menuRightIndent: ', menuRightIndent);
  ...
  const classes = createHeaderStyles({menuRightIndent, menuLeftIndent);
