...
export const Header = ({ categories, currentItem }) => {
  ...
  let menuLeftIndent = React.useRef();
  let menuRightIndent = React.useRef();
  ...
  React.useEffect(() => {
    ...
    if (menuHtmlEls.current[currentItem]) {
      ...
      console.log('menuHtmlEls.current[currentItem].offsetLeft - winWidth / 2 + menuHtmlEls.current[currentItem].offsetWidth / 2', menuHtmlEls.current[currentItem].offsetLeft - winWidth / 2 + menuHtmlEls.current[currentItem].offsetWidth / 2)
    }
