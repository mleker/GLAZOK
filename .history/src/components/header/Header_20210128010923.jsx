...
export const Header = ({ categories, currentItem }) => {
  ...
  let menuLeftIndent = 0;
  let menuRightIndent = 0;
  ...
  // if (menuHtmlEls.current[currentItem]) {
    const menuLeftIndent = winWidth / 2 - menuHtmlEls.current[0].offsetLeft - menuHtmlEls.current[0].offsetWidth / 2;
    const menuRightIndent = winWidth / 2 - menuHtmlEls.current[Object.keys(menuHtmlEls.current).length - 1].offsetWidth / 2 - 30;
