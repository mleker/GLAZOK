...
export const Header = () => {
  ...
  const menuLeftIndent1 = menuHtmlEls.current[0] && winWidth / 2 - menuHtmlEls.current[0].offsetWidth / 2;
  const menuRightIndent1 = 0;
  // const menuRightIndent = menuHtmlEls.current[0] && winWidth / 2 - menuHtmlEls.current[menuHtmlEls.current.width - 1].offsetWidth / 2;
  console.log('menuHtmlEls.current.width: ', menuHtmlEls.current.width);
  console.log('menuIndents.menuLeftIndent: ', menuIndents.menuLeftIndent);
  console.log('menuLeftIndent1: ', menuLeftIndent1);
  ...
  React.useEffect(() => {
    ...
    if (menuLeftIndent1) {
      console.log('keke');
      setMenuIndents({menuLeftIndent: menuLeftIndent1, menuRightIndent: menuRightIndent1});
    } 
  });
  ...
  const classes = createHeaderStyles(menuLeftIndent1);
