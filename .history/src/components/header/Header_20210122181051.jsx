...
export const Header = () => {
  ...
  const menuItem2 = React.useRef(null);
  const menuLeftIndent = menuItem1.current && winWidth / 2 - menuItem1.current.offsetWidth / 2;
  const menuRightIndent = menuItem2.current && winWidth / 2 - menuItem2.current.offsetWidth / 2;
  menuItem1.current && console.log('menuItem1.current.offsetWidth: ', menuItem1.current.offsetWidth);
      ...
      {winWidth > global.maxWidth && (
        <div className={classes.header}>
          {headerItems && headerItems.map((item, i) => (
            <span
              key={i}
              ref={i === 0 ? menuItem1 : i === headerItems.length - 1 ? menuItem2 : null}
