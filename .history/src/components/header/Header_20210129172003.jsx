...
export const Header = ({ categories, initialCurrentItem, onMenuClick}) => {
  ...
  React.useEffect(() => {
    console.log('menuHtmlEls.current[initialCurrentItem] 1', menuHtmlEls.current[initialCurrentItem]);
    if (!!initialCurrentItem) {
      console.log('menuHtmlEls.current[initialCurrentItem] 2', menuHtmlEls.current[initialCurrentItem]);
