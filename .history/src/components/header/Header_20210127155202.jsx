...
export const Header = () => {
  ...
  React.useEffect(() => {
    ...
    if (menuHtmlEls.current[0]) {
      console.log('menuHtmlEls.current[currentItem].offsetLeft', menuHtmlEls.current[currentItem].offsetLeft);
      console.log('currentItem', menuHtmlEls.current[currentItem].offsetLeft);
