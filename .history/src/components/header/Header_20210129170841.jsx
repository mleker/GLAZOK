...
export const Header = ({ categories, initialCurrentItem }) => {
  ...
  console.log('initialCurrentItem header', initialCurrentItem);
  ...
  React.useEffect(() => {
    if (!!initialCurrentItem) {
      console.log('menuHtmlEls.current[initialCurrentItem]', menuHtmlEls.current[initialCurrentItem])
      ...
      menuWrapperHtmlEl.current.scrollLeft = menuHtmlEls.current[initialCurrentItem].offsetLeft - winWidth / 2 + menuHtmlEls.current[currentItem].offsetWidth / 2;
    }
  }, [initialCurrentItem])
