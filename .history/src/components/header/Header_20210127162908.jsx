...
export const Header = () => {
  ...
  const [currentItem, setCurrentItem] = React.useState(categories.find(item => item.custom_url === pathname).id - 1);
  ...
  categories && console.log('category: ', categories.find(item => item.custom_url === pathname).id - 1 );
