...
import { PopupScenario } from './PopupScenario';
import { Scenarios2 } from './Scenarios2';
import { acquireScrollLock } from './ScrollUtils';
import { BlackMarbleEnergy } from './BlackMarbleEnergy';
import { ArkologyEnergy } from './ArkologyEnergy';
import { SymbiontsEnergy } from './SymbiontsEnergy';
import { HaffEarthEnergy } from './HaffEarthEnergy';
...
const createHomePageStyles = createUseStyles({
  ...
  mapBg: {
    width: '100%',
    height: '100%',
    animation: 'init-fade-in 300ms linear',
  },
